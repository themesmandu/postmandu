...
<label class="assistive-text screen-reader-text" for="s">
	<?php esc_html_e( 'Search', 'postmandu' ); ?>
</label>
	<div class="input-group">
		<input class="field form-control" id="s" name="s" type="text" placeholder="<?php esc_attr_e( 'Search &hellip;', 'postmandu' ); ?>" value="<?php the_search_query(); ?>">
		<span class="input-group-append">
			<input class="submit btn-postmandu" id="searchsubmit" name="submit" type="submit" value="<?php esc_attr_e( 'Search', 'postmandu' ); ?>">
		</span>
	</div>
</form>
